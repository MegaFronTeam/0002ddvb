...
// 				offsetHeight: t
// 			} = r, a = ((e / 2) ** 2 + (t / 2) ** 2) ** .5;
// 			i.style.width = 4 * a + "px", i.style.height = 4 * a + "px", i.style.marginLeft = "vertical" === s ? `-${2 * a}px` : `-${a}px`, i.style.marginTop = "vertical" === s ? `-${a}px` : `-${2 * a}px`
// 		};
// 	i = document.createElement("div"), i.classList.add("paper-onboarding-fills"), r.prepend(i), r.querySelectorAll(".swiper-slide").forEach((e => {
// 		const t = e.getAttribute("data-paper-bg-color") || "#000",
// 			a = document.createElement("div");
// 		a.classList.add("paper-onboarding-fill"), a.style.backgroundColor = t, i.appendChild(a), o.push(a)
// 	})), n(), window.addEventListener("resize", n), new e(r.querySelector(".swiper"), {
// 		modules: [t, a],
// 		effect: "creative",
// 		direction: s,
// 		speed: 500,
